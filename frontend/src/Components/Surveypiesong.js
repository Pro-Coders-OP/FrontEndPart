...
export default function Surveypieemotion({ onRouteChange, isSignedIn }) {
    return (
        ...
        <div className="container-fluid  border-top">
                ...
                <div className="col-11 text-center mx-auto"><h2 className=" mt-3 text-light" style={{ fontFamily:"Potta One, cursive"}}>Variation of Song preference among different age groups</h2></div>
