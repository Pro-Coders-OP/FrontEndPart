...
export default function Surveypieemotion() {
    return (
        ...
        <div className="container-fluid  border-top">
            <div className="row">
                <div className="col-12 text-center"><h2 className=" mt-3 text-light" style={{ fontFamily:"Potta One, cursive"}}>Variation of emotions among different age groups</h2></div>
